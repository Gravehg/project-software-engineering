...
@Component({
  selector: 'app-tickets-by-support',
  standalone: true,
  ...
  DatePipe,],
  imports: [TranslateModule, NavBarAdminComponent, RouterModule, NgStyle, MatFormFieldModule, MatInputModule, MatDatepickerModule, CommonModule, FormsModule],
  templateUrl: './tickets-by-support.component.html',
  styleUrl: './tickets-by-support.component.css'
})
export class TicketsBySupportComponent implements OnInit {
  ...
  onSearchTicketsBySupport() {
    this.adminService.getSupportTicketsByEmial(this.email).subscribe({
